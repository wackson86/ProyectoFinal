		...
		<div class="container">
			<div class="row">
				<div class="header-inner">
					...
					<nav role="navigation">
						<ul>
							<li><a href="buy.blade.php">Buy</a></li>
							<li><a href="rent.blade.php">Rent</a></li>
							<li class="active"><a href="properties.blade.php">Properties</a></li>
							<li class="call"><a href="tel://123456789"><i class="icon-phone"></i> +1 123 456 789</a></li>
							<li class="cta"><a href="contact.blade.php">Contact us</a></li>
						</ul>
					</nav>
				</div>
			</div>
